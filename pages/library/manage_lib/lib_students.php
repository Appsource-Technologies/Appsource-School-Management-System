                    ...
                    <div class="row">
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                $queryDup = "select distinct student_id,fname,sname,sex,class_name,stream_name ,level,comb_name from student_info,houses,class,academic_yr,streams,combinations where(student_info.house_id=houses.house_id and student_info.class_id=class.class_id and student_info.stream_id=streams.stream_id and student_info.comb_id=combinations.comb_id)";
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($users_list->results() as $users_list) :
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="index.php?page=give_studentbook&action=borror_book&student_id=<?php echo $users_list->student_id . '&token=' . Token::generate(); ?>"  class="btn btn-warning btn-xs"><i class="fa fa-shopping-cart"></i> Give out </a>
                                                    </td>
                                                </tr>  
                                                <?php
                                                $no++;
